...
function formatOutput(fontData){
	const text = document.createTextNode(JSON.stringify(fontData, null, "\t"));
	document.body.appendChild(text);
}

loadImage("Solarize.12x29.png").then(img => formatOutput(sliceImage(img, 32, 16)));
